...
func (s *TraderStore) initTables() error {
	_, err := s.db.Exec(`
		CREATE TABLE IF NOT EXISTS traders (
			...
			copy_follow_open BOOLEAN DEFAULT 1,
			copy_follow_add BOOLEAN DEFAULT 1,
			copy_follow_reduce BOOLEAN DEFAULT 1,
			copy_follow_close BOOLEAN DEFAULT 1,
			copy_leverage_sync BOOLEAN DEFAULT 1,
			copy_margin_sync BOOLEAN DEFAULT 1,
	...
	alterQueries := []string{
		...
		`ALTER TABLE traders ADD COLUMN copy_follow_open BOOLEAN DEFAULT 1`,
		`ALTER TABLE traders ADD COLUMN copy_follow_add BOOLEAN DEFAULT 1`,
		`ALTER TABLE traders ADD COLUMN copy_follow_reduce BOOLEAN DEFAULT 1`,
		`ALTER TABLE traders ADD COLUMN copy_follow_close BOOLEAN DEFAULT 1`,
		`ALTER TABLE traders ADD COLUMN copy_leverage_sync BOOLEAN DEFAULT 1`,
		`ALTER TABLE traders ADD COLUMN copy_margin_sync BOOLEAN DEFAULT 1`,
